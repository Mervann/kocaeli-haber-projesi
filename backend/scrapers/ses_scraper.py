"""Scraper for seskocaeli.com — Uses Google News RSS to discover articles
...
class SesScraper(BaseScraper):
    ...
    GOOGLE_NEWS_RSS = "https://news.google.com/rss/search?q=site:seskocaeli.com+Kocaeli&hl=tr&gl=TR&ceid=TR:tr"
    ...
    def get_article_urls(self, days=3) -> list[dict]:
            ...
            if html:
                ...
                for item in soup.find_all("item"):
                    ...
                    if link_tag:
                        ...
                        if url and "seskocaeli.com" in url and url not in seen:
                            seen.add(url)
        ...
        # 2. Always try direct listing pages (not just when RSS is empty)
        for listing_url in [
