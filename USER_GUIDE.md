# 📰 Kocaeli News Aggregator & Scraper — User & Technical Guide
...
| :--- | :--- | :--- |
| **Scraper Engine** | Anti-Bot Bypass | Built with `cloudscraper` & `curl_cffi` to bypass Cloudflare protection |
| **Pagination Handler** | Multi-Page Scraping | Traverses paginated news listings seamlessly |
| **Date Verifier** | Data Sanitization | Validates publication dates and filters outdated entries |
| **Frontend UI** | Category Banners & Feeds | Displays news with responsive image grids and status badges |
| **Trigger System** | Automated Scheduling | `trigger_scrape.py` script for periodic background scraping |
